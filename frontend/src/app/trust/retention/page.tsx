        ...
        <div className="re-page">
            ...
            <section className={`relative z-[2] ${sectionAlt}`}>
                <div className="max-w-[980px] mx-auto py-10 sm:py-14 px-4 sm:px-6">
                    <h2 className="text-2xl font-bold text-[var(--re-text-primary)] mb-2">Retention timeline</h2>
            ...
            {/* Export scheduling */}
            <section className="relative z-[2] max-w-[980px] mx-auto py-10 sm:py-14 px-4 sm:px-6">
                <h2 className="text-2xl font-bold text-[var(--re-text-primary)] mb-4">Automated export scheduling</h2>
