...
export default function BiasCheckerPage() {
  ...
  return (
    <>
      <style jsx global>{`
        :root {
          --bc-bg: var(--re-surface-base, #06090f);
          --bc-surface: var(--re-surface-card, #0c1017);
          --bc-elevated: var(--re-surface-elevated, #111827);
          --bc-border: rgba(255,255,255,0.08);
          --bc-border-strong: rgba(255,255,255,0.15);
          --bc-text: var(--re-text-primary, #f8fafc);
          --bc-text-muted: var(--re-text-muted, #64748b);
          --bc-text-dim: var(--re-text-disabled, #475569);
          --bc-accent: var(--re-brand, #10b981);
          --bc-accent-hover: var(--re-brand-light, #34d399);
          --bc-fail: #ef4444;
          --bc-fail-bg: rgba(239,68,68,0.1);
          --bc-warn: #f59e0b;
          --bc-warn-bg: rgba(245,158,11,0.1);
          --bc-pass: var(--re-brand, #10b981);
