...
export default function SupplierauditDocsPage() {
    return (
        <>            <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="mb-8">
                    <h1 className="text-4xl font-bold mb-2">Supplier Audit Management</h1>
                    <p className="text-muted-foreground">
                        Manage supplier quality assurance audits
                    </p>
                </div>
