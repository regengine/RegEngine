...
export default function NcrDocsPage() {
    return (
        <>            <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="mb-8">
                    <h1 className="text-4xl font-bold mb-2">Non-Conformance Reports</h1>
                    <p className="text-muted-foreground">
                        Track and resolve quality non-conformances
                    </p>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Detailed documentation for non-conformance reports is under development
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
