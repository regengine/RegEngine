...
const mockTenants = [
    ...
    { id: '2', name: 'GlobalTech Solutions', plan: 'Professional', status: 'active', mrr: 4999, documents: 890, users: 8, createdAt: '2024-02-20' },
    { id: '3', name: 'MedSecure Health', plan: 'Enterprise', status: 'active', mrr: 15000, documents: 4200, users: 45, createdAt: '2023-11-10' },
    { id: '4', name: 'EnergyFlow Corp', plan: 'Starter', status: 'trial', mrr: 0, documents: 45, users: 2, createdAt: '2024-03-01' },
    { id: '5', name: 'SafetyFirst Manufacturing', plan: 'Professional', status: 'active', mrr: 4999, documents: 1200, users: 12, createdAt: '2024-01-28' },
    { id: '6', name: 'NuclearSafe Inc.', plan: 'Enterprise', status: 'active', mrr: 25000, documents: 8900, users: 67, createdAt: '2023-08-05' },
    { id: '7', name: 'FinanceHub Partners', plan: 'Professional', status: 'churned', mrr: 0, documents: 560, users: 5, createdAt: '2023-12-01' },
];
