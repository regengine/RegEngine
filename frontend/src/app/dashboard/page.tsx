...
const getQuickActions = (tenantType: 'retailer' | 'supplier' | 'system') => {
    const commonActions = [
        {
            title: 'FSMA Dashboard',
            description: 'Traceability & recall management',
            icon: Shield,
            href: '/fsma',
        ...
        },
        {
            ...
            description: 'Upload regulatory documents',
            icon: Upload,
            href: '/ingest',
            color: 'text-blue-500',
        ...
        },
        {
            ...
            description: 'Review extracted obligations',
            icon: FileCheck,
            href: '/compliance',
    ...
    if (tenantType === 'retailer') {
        return [
            ...
            {
                title: 'Opportunities',
                description: 'Regulatory arbitrage finder',
                icon: TrendingUp,
                href: '/opportunities',
    ...
    if (tenantType === 'supplier') {
        return [
            ...commonActions,
            {
                ...
                description: 'Trace products end-to-end',
                icon: Search,
                href: '/trace',
                color: 'text-amber-500',
                bg: 'bg-amber-100 dark:bg-amber-900/30',
            },
            {
                ...
                description: 'Active shipments & CTEs',
                icon: Truck,
                href: '/shipments',
                color: 'text-rose-500',
                bg: 'bg-rose-100 dark:bg-rose-900/30',
            },
            {
                ...
                description: 'Customer compliance demands',
                icon: Building2,
                href: '/requirements',
                color: 'text-indigo-500',
                bg: 'bg-indigo-100 dark:bg-indigo-900/30',
