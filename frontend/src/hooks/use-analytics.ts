...
export function useAnalyticsOverview() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>('/v1/billing/analytics/overview'),
        staleTime: 30_000,
...
export function useMRRHistory(months = 12) {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>(`/v1/billing/analytics/mrr-history?months=${months}`),
        staleTime: 60_000,
    });
}
...
export function useCohortAnalysis() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>('/v1/billing/analytics/cohorts'),
        staleTime: 120_000,
    });
}
...
export function useConversionFunnel() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>('/v1/billing/analytics/funnel'),
        staleTime: 60_000,
    });
}
...
export function useCreditProgramROI() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>('/v1/billing/analytics/credits'),
        staleTime: 120_000,
    });
}
...
export function useRevenueForecasts(months = 6) {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>(`/v1/billing/analytics/forecasts?months=${months}`),
        staleTime: 120_000,
    });
}
...
export function useUsageSummary(tenantId: string, tierId = 'growth') {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>(`/v1/billing/usage/${tenantId}/summary?tier_id=${tierId}`),
        enabled: !!tenantId,
        staleTime: 30_000,
    });
}
...
export function useUsageBreakdown(tenantId: string, tierId = 'growth') {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>(`/v1/billing/usage/${tenantId}/breakdown?tier_id=${tierId}`),
        enabled: !!tenantId,
        staleTime: 60_000,
    });
}
...
export function useOverageAlerts() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<any>('/v1/billing/usage/overage-alerts'),
        staleTime: 30_000,
        refetchInterval: 60_000,
    });
}
