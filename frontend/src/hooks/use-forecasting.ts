...
export function useMRRHistory() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>('/v1/billing/forecasting/mrr/history'),
        staleTime: 60_000,
    });
}
...
export function useMRRForecast(months = 6) {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>(`/v1/billing/forecasting/mrr/forecast?months=${months}`),
        staleTime: 60_000,
    });
}
...
export function useChurnScores(risk?: string) {
    ...
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>(`/v1/billing/forecasting/churn/scores${qs}`),
        staleTime: 30_000,
    });
}
...
export function useChurnOverview() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>('/v1/billing/forecasting/churn/overview'),
        staleTime: 30_000,
    });
}
...
export function useCLVEstimates() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>('/v1/billing/forecasting/clv'),
        staleTime: 60_000,
    });
}
...
export function useCLVSummary() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>('/v1/billing/forecasting/clv/summary'),
        staleTime: 60_000,
    });
}
...
export function useRetentionMatrix() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>('/v1/billing/forecasting/cohorts/retention'),
        staleTime: 120_000,
    });
}
...
export function useRevenueAnomalies() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>('/v1/billing/forecasting/anomalies'),
        staleTime: 30_000,
    });
}
...
export function useExecutiveSummary() {
    return useQuery({
        ...
        queryFn: () => fetchJSON<unknown>('/v1/billing/forecasting/summary'),
        staleTime: 30_000,
    });
}
