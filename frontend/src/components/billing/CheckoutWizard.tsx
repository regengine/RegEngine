...
const PLANS = [
    {
        id: 'starter', name: 'Starter', description: 'For small operations getting started',
        monthlyPrice: 299, annualPrice: 249, cteLimit: '10,000', highlighted: false,
        features: [
    ...
    {
        id: 'growth', name: 'Growth', description: 'For growing companies with multiple facilities',
        monthlyPrice: 799, annualPrice: 665, cteLimit: '100,000', highlighted: true,
        features: [
    ...
    {
        id: 'scale', name: 'Scale', description: 'For enterprises with complex supply chains',
        monthlyPrice: 1999, annualPrice: 1665, cteLimit: '1,000,000', highlighted: false,
        features: [
