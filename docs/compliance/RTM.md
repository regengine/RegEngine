...
| **§ 1.1325–1.1345** | **Records of Critical Tracking Events (CTEs)** | Graph Service | `services/graph/app/models.py` | Graph Schema |
| § 1.1325 | Harvesting/Cooling (Location, Date, Quantity) | Graph Service | `services/graph/app/routers/trace.py` | Trace E2E Test |
| § 1.1327 | Initial Packing (Pack date, input lots, harvester) | Ingestion Service | `services/ingestion/app/parsers/` | Parser Tests |
| § 1.1330 | First Land-Based Receiver (Landing date, vessel, BOL) | Graph Service | `services/graph/app/routers/trace.py` | Trace E2E Test |
| § 1.1335 | Shipping (TLC Source, Previous Source) | Graph Service | `services/graph/app/consumers/fsma_consumer.py` | Consumer Tests |
| § 1.1340 | Receiving (Location, Date, Quantity, TLC) | Graph Service | `services/graph/app/consumers/fsma_consumer.py` | Consumer Tests |
| § 1.1345 | Transformation (Input/Output Lots) | Compliance Service | `services/compliance/fsma_engine.py` | Mass Balance Logic |
