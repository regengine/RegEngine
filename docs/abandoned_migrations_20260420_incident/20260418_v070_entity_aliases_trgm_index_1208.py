"""entity_aliases: pg_trgm GIN index for fuzzy search — #1208.

Before: ``IdentityResolutionService.find_potential_matches`` pulled
every name/trade_name/abbreviation alias for the tenant into Python
and ran Ratcliff/Obershelp (``SequenceMatcher``) pairwise. For a
tenant with 100K aliases this is multi-second per call, and
