...
class TestRedisHelpers:
    ...
    def test_publish_graph_sync_no_redis_url_is_noop(self, monkeypatch):
        # #1378: even with the feature enabled, absent REDIS_URL must no-op.
    ...
    def test_publish_graph_sync_success(self, monkeypatch):
        # #1378: explicit opt-in is required to actually publish.
        monkeypatch.setenv("ENABLE_NEO4J_SYNC", "true")
        ...
        class _Client:
            ...
            def ltrim(self, topic, start, stop):
                # Accept LTRIM silently; a separate test verifies it runs.
                return True
