...
BUCKET = os.getenv("PROCESSED_DATA_BUCKET", "reg-engine-processed-data-dev")
DB_CONFIG = {
    "host": "postgres",
    "port": 5432,
...
def test_s3_integrity():
    print("Executing HASH-002: S3 Normalized Content Tamper Test (Docker)")
    print("---------------------------------------------------------")
    ...
    try:
        ...
        if computed_hash != expected_hash:
            ...
            print("HASH-002 FAIL: Hash still matches?")
